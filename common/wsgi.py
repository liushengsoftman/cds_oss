...
bind_opts = [
    ...
    cfg.IntOpt('bind_port', default=8484,
...
class Server(object):
    ...
    def start(self, application, default_port):
        ...
        try:
            ...
            # NOTE(flaper87): When running cdsoss-control,
            # (cdsoss's functional tests, for example)
            # setpgid fails with EPERM as cdsoss-control
            ...
            #
            # Running cdsoss-(api|registry) is safe and
        ...
        self.logger = logging.getLogger('cdsoss.wsgi.server')
...
class Request(webob.Request):
    ...
    def best_match_language(self):
        ...
        if not self.accept_language:
            return None
        langs = gettextutils.get_available_languages('cdsoss')
