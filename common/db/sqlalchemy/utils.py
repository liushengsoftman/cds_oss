...
from cdsoss.common import context as request_context
from cdsoss.common.db.sqlalchemy import models
from cdsoss.common.gettextutils import _, _LI, _LW
...
# copy from cdsoss/db/sqlalchemy/api.py
...
def drop_unique_constraint(migrate_engine, table_name, uc_name, *columns,
    ...
    DEPRECATED: this function is deprecated and will be removed from cdsoss.db
