...
from cdsoss.common.db.sqlalchemy import utils
from cdsoss.common.fixture import lockutils
from cdsoss.common import test
...
class OpportunisticFixture(DbFixture):
    ...
    DBNAME = PASSWORD = USERNAME = 'cdsoss_citest'
...
class OpportunisticTestCase(DbTestCase):
    ...
    The subclasses of the test case are running only when cdsoss_citest
    ...
    def setUp(self):
        ...
        # https://review.cdsoss.org/#/c/74963/ to merge.
