...
class RequestContext(object):
    ...
    def to_dict(self):
        ...
        # format string for logging the context in cdsoss common
        ...
        return {
            ...
            #NOTE(bcwaldon): cdsoss-common logging expects 'user'
            'user': self.user,
            'user_id': self.user,

            #NOTE(bcwaldon): cdsoss-common logging expects 'tenant'
            'tenant': self.tenant,
    ...
    @property
    def owner(self):
        """Return the owner to correlate with an cdsoss."""
