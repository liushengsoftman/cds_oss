...
class BaseContextMiddleware(wsgi.Middleware):
    def process_response(self, resp):
        try:
            ...
            resp.headers['x-cdsoss-request-id'] = 'req-%s' % request_id
        return resp
...
class ContextMiddleware(BaseContextMiddleware):
    ...
    def process_request(self, req):
        ...
        Generate a cdsoss.context.RequestContext object from the available
    ...
    def _get_anonymous_context(self):
        ...
        return cdsoss.context.RequestContext(**kwargs)
...
class UnauthenticatedContextMiddleware(BaseContextMiddleware):
    def process_request(self, req):
        ...
        req.context = cdsoss.context.RequestContext(**kwargs)
